  ...
  return (
    <main className="text-center my-4">
      <table
        ...
        className="border border-black m-auto text-left inline-grid gap-4 grid-cols-3"
      >
        ...
        <tbody className="contents">
          <tr className="contents">
            <th id="subheader-one" className="col-span-3">
              Subheader for following rows and columns
            </th>
          </tr>
          <tr className="contents">
            <th scope="row" headers="subheader-one">Subsubheader for columns in row</th>
